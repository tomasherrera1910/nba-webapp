        ...
        return players.map(player => (
            {
                ...
                Position: player.Position,
                Games: player.Games,
                FieldGoalsPercentage: formatPercentages(player.FieldGoalsMade, player.FieldGoalsAttempted),
                ThreePointersPercentage: formatPercentages(player.ThreePointersMade, player.ThreePointersAttempted),
                FreeThrowsPercentage: formatPercentages(player.FreeThrowsMade, player.FreeThrowsAttempted),
